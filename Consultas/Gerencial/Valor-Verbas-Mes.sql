 SELECT NVL(VENDAS.CODUSUR, DEVOLUCAO.CODUSURDEVOL) CODUSUR, 
        ...
        (SUM(NVL(VENDAS.VLVENDA,0) - NVL(DEVOLUCAO.VLDEVOLUCAO,0))) * 0.0175 AS VERBA,
        (CASE WHEN VENDAS.CODUSUR = 160 THEN 600 ELSE 0 END) AS ABATIMENTOS, 0 AS TOTAL
...
WHERE P.CODFORNEC = PCFORNEC.CODFORNEC AND NVL(P.REVENDA,'S')  = 'S' ) QTMIXCADNOVO,
 ...
 WHERE PCMOV.NUMTRANSVENDA = PCNFSAID.NUMTRANSVENDA
   ...
   AND PCMOV.DTMOV BETWEEN  TO_DATE('01/03/2024', 'DD/MM/YYYY') AND 
  ...
  AND PCMOV.CODOPER <> 'SO' 
   ...
   AND PCNFSAID.DTSAIDA BETWEEN  TO_DATE('01/03/2024', 'DD/MM/YYYY') AND 
                                 TO_DATE('31/03/2024', 'DD/MM/YYYY') 
...
PCMETA.CODIGO,
 ...
 WHERE PCMETA.CODUSUR = PCUSUARI.CODUSUR
   ...
   AND PCMETA.DATA BETWEEN  TO_DATE('01/03/2024', 'DD/MM/YYYY') AND 
                            TO_DATE('31/03/2024', 'DD/MM/YYYY') 
 ...
 ,(SELECT DISTINCT CASE                                          
   ...
   AND PED.DATA BETWEEN  TO_DATE('01/03/2024', 'DD/MM/YYYY') AND 
                              TO_DATE('31/03/2024', 'DD/MM/YYYY') 
      ) TEMVENDATV8 
...
AND NVL(PCNFSAID.CODSUPERVISOR,PCUSUARI.CODSUPERVISOR) = PCSUPERV.CODSUPERVISOR
 ...
 AND DECODE(PCNFSAID.CODGERENTE,NULL,PCSUPERV.CODGERENTE,PCNFSAID.CODGERENTE) = PCGERENTE.CODGERENTE
   ...
   AND PCNFENT.DTENT BETWEEN  TO_DATE('01/03/2024', 'DD/MM/YYYY') AND 
                              TO_DATE('31/03/2024', 'DD/MM/YYYY') 
