...
SELECT   DISTINCT(WINT.CODSEC), WINT.SECAO, WINT.CODUSUR, ROUND(SUM(WINT.VLVENDA),2) AS "VLVENDA", 
        ROUND(
                CASE
                        WHEN (((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * DU3.QTDIASVENDAS) + ((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * 0.05)) < 1000 THEN 1000
                        ELSE (((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * DU3.QTDIASVENDAS) + ((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * 0.05))
                END,
                2
        ) AS "META MÊS",
        ROUND(
                CASE
                        WHEN (((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * DU3.QTDIASVENDAS) + ((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * 0.05)) < 1000 THEN 1000 / DU3.QTDIASVENDAS
                        ELSE (((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * DU3.QTDIASVENDAS) + ((SUM(WINT.VLVENDA) / (DU1.QTDIASVENDAS + DU2.QTDIASVENDAS)) * 0.05)) / DU3.QTDIASVENDAS
                END,
                2
        ) AS "META DIA"
