...
WHERE A.DATA BETWEEN '26-nov-2023' AND '07-jan-2024'
    AND U.CODSUPERVISOR IN (2,8,9)--({CBBSUP})
    AND A.CODUSUR IN (2, 149, 160, 140, 141, 142, 157, 164, 145, 148, 150, 180, 169,
                     151, 152, 153, 155, 156, 158, 161, 167, 168, 170, 172, 174, 143,147) --({RCA})
