DECLARE
  CODPROD_PRODUTO_MODELO NUMBER := 18140;  -- INSERIR O CÓDIGO DO PRODUTO QUE FOI FEITO O PREENCHIMENTO MANUAL
...
SELECT DISTINCT PCTABPR.CODPROD                
 ...
 WHERE ((PCTABPR.NUMREGIAO = PCREGIAO.NUMREGIAO  
   ...
   AND CODPROD IN (SELECT CODPROD FROM PCPRODUT WHERE CODFORNEC = 1488)
